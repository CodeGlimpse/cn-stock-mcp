...
Windows 配置文档已覆盖 [13 款 Agent](HOST_CONFIG_TEMPLATES.md)，统一前置步骤见 [共同准备](WINDOWS_AGENT_SETUP.md)。本轮按用户要求只核对官方资料与离线配置语法，不执行 Host 连接或行情测试；来源见 [核对记录](HOST_CONFIGURATION_SOURCES.md)。
