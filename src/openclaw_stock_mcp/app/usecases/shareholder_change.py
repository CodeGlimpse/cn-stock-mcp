...
from openclaw_stock_mcp.app.models.shareholder_change import ShareholderChangeResult
...
from openclaw_stock_mcp.providers.adapters.akshare_shareholder_change_adapters import (
    adapt_change_row,
    adapt_top10_row,
