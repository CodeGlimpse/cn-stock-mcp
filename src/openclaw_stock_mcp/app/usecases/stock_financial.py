...
from openclaw_stock_mcp.app.models.financial import StockFinancialResult
from openclaw_stock_mcp.providers.adapters.akshare_financial_adapters import build_financial_summary_text
    ...
    def execute(self, request) -> dict:
        ...
        if "snapshot" in include or "history" in include:
            ...
            if report_date and snapshot and snapshot.report_date != report_date:
                from openclaw_stock_mcp.providers.adapters.akshare_financial_adapters import build_financial_snapshot_from_abstract
