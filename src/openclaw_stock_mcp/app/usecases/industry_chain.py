...
from openclaw_stock_mcp.app.models.industry_chain import IndustryChainResult
...
from openclaw_stock_mcp.providers.adapters.akshare_industry_chain_adapters import (
    adapt_concept_row,
    adapt_industry_row,
