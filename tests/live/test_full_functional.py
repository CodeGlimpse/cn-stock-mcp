...
FUNCTIONAL_CASES: tuple[FunctionalCase, ...] = (
    ...
    FunctionalCase("multi_timeframe_review", lambda c: {"symbol": c["stock"], "sec_type": "stock", "intervals": ["1d", "1w"], "indicators": ["macd"], "limit": 5}, ("items", "summary"), True),
    ...
    FunctionalCase("sector_rotation_review", lambda c: {"sector_names": [c["primary_sector"]], "sector_type": "primary", "trade_date": c["recent_date"], "top_n": 1, "member_top_n": 2, "limit": 5}, ("items", "member_count", "summary"), True, "primary_sector"),
